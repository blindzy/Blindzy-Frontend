        ...
        <div className="w-full p-4 flex flex-col items-center gap-2.5 border border-[--Black] rounded-24">
            <div className="w-full flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <h6 className="text-md text-[--Black]">{props.data.title}</h6>
                </div>
                <h6 className="text-md text-[--Black]">
                    {(() => {
            ...
            <div className="flex items-center gap-1 cursor-pointer" onClick={toggleDetails}>
