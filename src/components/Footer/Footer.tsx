                ...
                <div className="flex sm:flex-row flex-col xl:items-stretch xl:gap-[1.25vw] sm:gap-4 gap-4">
                    ...
                    <a href="/contact" className="w-full xl:h-[17.4603vh] sm:h-[20vw] p-6 flex items-center justify-center gap-3 xl:text-[1.094vw] sm:text-[2.758vw] text-[4.884vw] font-bold font-plus leading-normal bg-[--Black] text-[--white] transition hover:text-[--Black] hover:bg-[--white] sm:rounded-[48px] rounded-full">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
                            ...
                            <path d="M24.4455 24.0553V8.94423C24.4455 6.98055 22.8537 5.38867 20.89 5.38867H11.1122C9.14852 5.38867 7.55664 6.98055 7.55664 8.94423V24.0553C7.55664 26.0191 9.14852 27.6109 11.1122 27.6109H20.89C22.8537 27.6109 24.4455 26.0191 24.4455 24.0553Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M28.8887 8.05518V24.9441" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M3.11133 8.05518V24.9441" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </a>
                </div>
            </div>
                        ...
                        <a href="aithur.com" className="text-[--Black] hover:text-[--primary] transition">
                            <svg xmlns="http://www.w3.org/2000/svg" className="sm:w-[92px] sm:h-[24px] w-[56px] h-[18px]" width="92" height="24" viewBox="0 0 92 24" fill="none">
                                <g clipPath="url(#clip0_30_1229)">
                                    <path d="M9.50266 24.0001C7.37746 23.9975 5.6669 22.2778 5.67384 20.1512C5.68078 18.0351 7.39308 16.3206 9.50266 16.3162C11.6252 16.3128 13.3532 18.0507 13.3436 20.1816C13.3341 22.2978 11.6192 24.0027 9.50266 24.0001Z" fill="currentColor" />
                                    <path d="M29.666 20.958C29.1455 21.1319 26.63 21.5666 25.0686 19.3931C23.3225 16.9631 21.6119 10.4043 21.2519 7.9169C21.0975 6.85274 19.5171 0.26611 13.3584 0.00528763C8.32729 -0.168594 6.87175 4.44014 6.87175 4.44014C6.87175 4.44014 5.28263 9.61746 3.55645 11.0468C1.56137 12.6986 0 11.9162 0 11.9162C0 11.9162 4.42388 16.0893 8.32729 14.0897C12.2307 12.0901 13.4451 8.00384 13.4451 8.00384C13.4451 8.00384 14.6829 14.4722 15.6683 16.7153C16.0899 17.6743 17.6955 23.1315 22.0326 23.7401C26.3698 24.3487 29.666 20.958 29.666 20.958Z" fill="currentColor" />
                                    <rect x="26.3516" y="3.46729" width="3.83594" height="16.7728" rx="1.91797" fill="currentColor" />
                                    <rect x="26.3516" y="3.46729" width="3.83594" height="16.7728" rx="1.91797" fill="currentColor" />
                                    <path d="M45.0098 5.1383C45.0098 4.21543 45.7565 3.46729 46.6776 3.46729H47.1779C48.099 3.46729 48.8457 4.21543 48.8457 5.1383V8.543C48.8457 9.46588 49.238 9.77538 50.1591 9.77538H52.2647C53.1858 9.77538 53.5989 9.46588 53.5989 8.543V5.1383C53.5989 4.21543 54.3456 3.46729 55.2667 3.46729H55.7671C56.6882 3.46729 57.4349 4.21543 57.4349 5.1383V18.5691C57.4349 19.492 56.6882 20.2401 55.7671 20.2401H55.2667C54.3456 20.2401 53.5989 19.492 53.5989 18.5691V14.6631C53.5989 13.7402 53.1858 13.4516 52.2647 13.4516H50.1591C49.238 13.4516 48.8457 13.7402 48.8457 14.6631V18.5691C48.8457 19.492 48.099 20.2401 47.1779 20.2401H46.6776C45.7565 20.2401 45.0098 19.492 45.0098 18.5691V5.1383Z" fill="currentColor" />
                                    <path d="M45.0098 5.1383C45.0098 4.21543 45.7565 3.46729 46.6776 3.46729H47.1779C48.099 3.46729 48.8457 4.21543 48.8457 5.1383V8.543C48.8457 9.46588 49.238 9.77538 50.1591 9.77538H52.2647C53.1858 9.77538 53.5989 9.46588 53.5989 8.543V5.1383C53.5989 4.21543 54.3456 3.46729 55.2667 3.46729H55.7671C56.6882 3.46729 57.4349 4.21543 57.4349 5.1383V18.5691C57.4349 19.492 56.6882 20.2401 55.7671 20.2401H55.2667C54.3456 20.2401 53.5989 19.492 53.5989 18.5691V14.6631C53.5989 13.7402 53.1858 13.4516 52.2647 13.4516H50.1591C49.238 13.4516 48.8457 13.7402 48.8457 14.6631V18.5691C48.8457 19.492 48.099 20.2401 47.1779 20.2401H46.6776C45.7565 20.2401 45.0098 19.492 45.0098 18.5691V5.1383Z" fill="currentColor" />
