export class UpdateCart {
    ...
    private baseUrl = import.meta.env.VITE_API_URL || "https://api.blindzy.com"; // Medusa backend URL
    ...
    async updateCart(cartId: string, userData: {
        quantity: number;
    }): Promise<any> {
        try {
...
export const updateCart = new UpdateCart();
